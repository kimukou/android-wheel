...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
	...
	/** Default text gravity */
	public static final int DEFAULT_TEXT_GRAVITY = Gravity.CENTER;

	/** Default text style */
	public static final int DEFAULT_TEXT_STYLE = Typeface.BOLD;

	/** Default text style (null means use default font) */
	public static final Typeface DEFAULT_TEXT_TYPEFACE = null;

	// Text settings
	private int textColor = DEFAULT_TEXT_COLOR;
	private int textSize = DEFAULT_TEXT_SIZE;
	private int textGravity = DEFAULT_TEXT_GRAVITY;
	private Typeface textTypeface = DEFAULT_TEXT_TYPEFACE;
	private int textStyle = DEFAULT_TEXT_STYLE;
